...
>
  <div class="container mx-auto px-4">
    <nav class="flex items-center justify-between h-20">
      <a href="/" class="text-2xl font-bold text-primary">Café Aroma</a>
      ...
      >
        <div class="w-6 h-6 relative">
          ...
          ></span>
          <span 
            class="absolute w-full h-0.5 bg-gray-800 top-1/2 -translate-y-1/2 transition-opacity duration-300"
